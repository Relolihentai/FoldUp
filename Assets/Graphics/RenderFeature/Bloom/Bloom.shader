Shader "PostProcessing/Bloom"
{
    ...
    SubShader
    {
        ...
        float3 GaussNxN(SamplerState tex,float2 uv,int n,float2 stride,float sigma)
        {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                color.rgb = GaussNxN(sampler_MainTex, i.uv, 5,_MainTex_TexelSize.xy, 1.0);
                return color;
            }
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                color.rgb = GaussNxN(sampler_PrewMip, i.uv,5, prev_stride,1)
                                + GaussNxN(sampler_MainTex, i.uv,5, curr_stride,1);
                return color;
            }
            ENDHLSL
        }
